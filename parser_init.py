...
INPUT_PROMPT = "pokemon, Plumber-type, Mushroom-shaped hat, Overalls attire, Moustache accessory, Jumping ability, Coin-collecting instinct, Pipe-traveler, Power-up transformations".replace("'","")
